...
const socialsData: SocialNetworks[] = [
  {
    id: 1,
    icon: <FaTwitter />,
    url: "https://www.facebook.com/wania.ansari.902",
  },
  {
    id: 2,
    icon: <FaFacebookF />,
  ...
  },
  {
    id: 3,
    icon: <FaInstagram />,
    url: "https://www.instagram.com/wania_ajaz64/profilecard/?igsh=MWdzMnh6c2d3MnVnNQ==",
  },
  {
    id: 4,
    icon: <FaGithub />,
    url: "https://github.com/waniaajaz",
  },
];
        ...
        <div className="max-w-frame mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center sm:justify-between items-center mb-2">
            <p className="text-sm text-center sm:text-left text-black/60 mb-4 sm:mb-0 sm:mr-1">
              Shop.co © Made by 
              <Link
                href="https://github.com/waniaajaz"
                className="text-black font-medium"
              >
                  Wania Ajaz
              </Link>
              {", "}
              Designed by wania_ajaz
            </p>
            <div className="flex items-center">
